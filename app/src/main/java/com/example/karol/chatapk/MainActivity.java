...
//        if(currentUser != null){
//            //findViewById(R.id.)
//            findViewById(R.id.verifiyBtn2).setEnabled(!currentUser.isEmailVerified());
...
//         findViewById(R.id.verifiyBtn2).setEnabled(false);
//         final FirebaseUser user = firebaseAuth.getCurrentUser();
//         user.sendEmailVerification().addOnCompleteListener(this, new OnCompleteListener<Void>() {
//             @Override
//             public void onComplete(@NonNull Task<Void> task) {
//                 findViewById(R.id.verifiyBtn2).setEnabled(true);
//                 if(task.isSuccessful()){
